                                                ...
                                                <td class="column-4">
                                                    <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                                        ...
                                                        <input class="mtext-104 cl3 txt-center num-product" type="number"
                                                            {{-- số lượng sản phẩm --}} name="num_product[{{ $product->id }}]"
                                ...
                                <div class="size-100 p-r-18 p-r-0-sm w-full-ssm">
                                    ...
                                    <div class="p-t-15 ">
                                        ...
                                        <div class="bor8 bg0 m-b-12">
                                            <input class="stext-111 cl8 plh3 size-111 p-lr-15 border border-primary"
                                        ...
                                        <div class="bor8 bg0 m-b-12">
                                            <input class="stext-111 cl8 plh3 size-111 p-lr-15 border border-primary"
                                                type="text" name="address" placeholder=" Nhập Địa Chỉ Giao Hàng">
                                        </div>

                                        <div class="bor8 bg0 m-b-12">
                                            <input class="stext-111 cl8 plh3 size-111 p-lr-15 border border-primary"
                                                type="text" name="email" placeholder=" Nhập Email Liên Hệ">
                                        </div>

                                        <div class="bor8 bg0 m-b-12">
                                            <textarea class="cl8 plh3 size-111 p-lr-15 border border-primary" name="content"></textarea>
                                        </div>
